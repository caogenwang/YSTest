...
JNIEXPORT jobjectArray JNICALL
JNI_FN(MuPDFCore_hkselect)(JNIEnv * env, jobject thiz,jfloat x0,jfloat y0,jfloat x1,jfloat y1,jint number)
{
...
JNIEXPORT jobjectArray JNICALL
JNI_FN(MuPDFCore_hksearch)(JNIEnv * env, jobject thiz,jintArray uArray,jint number)
{
